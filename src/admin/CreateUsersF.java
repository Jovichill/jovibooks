...
public class CreateUsersF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(ust, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 310, 190, -1));
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
     ...
     + us.getText() + "','" + pw.getText() + "','" + ut.getSelectedItem() + "','"+ust.getSelectedItem()+"')")){
    ...
    private void upActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upActionPerformed
        ...
        dbConnector dbc = new dbConnector();
       dbc.updateData("UPDATE tbl_user SET u_fname ='"+fn.getText()+",u_lname = '"+ln.getText()+"', u_email ='"+mail.getText()+"', u_username='"+us.getText()+"', u_password = '"+pw.getText()+"', u_type = '"+ut.getSelectedItem()+"', u_status'"+ust.getSelectedItem()+"' WHERE u_id = '"+id.getText()+"'");
